...
bin/life: build/main.o build/life.o build/logic.o build/field.o build/field_print.o
	$(CC) $(CFLAGS) build/main.o build/life.o build/logic.o build/field.o build/field_print.o -o bin/life
...
build/logic.o: src/logic.c
	$(CC) $(CFLAGS) -c src/logic.c -o build/logic.o
